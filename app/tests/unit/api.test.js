...
describe('#/api/mot', function(){

  var log = console.log;

  before(function(done){
    require(ROOT_DIR + '/routes/mot')(app, settings);
    done();
  });
  ...
  it('- should GET mot', function(done){
    request(app)
      .get('/api/mot')
      .end(function(err, res){
        // Enable the console log to print the assertion output
    ...
    it('- should GET mot with parameter', function(done){
    request(app)
      .get('/api/mot?mot=chat')
      .end(function(err, res){
        // Enable the console log to print the assertion output
        console.log = log;
