...
var CountdownViewChildParentComponent = (function () {
    ...
    CountdownViewChildParentComponent.prototype.mod = function () { return i; };
    ...
    __decorate([
        ...
        __metadata('design:type', (typeof (_a = typeof countdown_timer_component_1.CountdownTimerComponent !== 'undefined' && countdown_timer_component_1.CountdownTimerComponent) === 'function' && _a) || Object)
