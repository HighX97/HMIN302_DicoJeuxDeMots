...
var MissionControlComponent = (function () {
    function MissionControlComponent(missionService) {
        ...
        missionService.missionConfirmed$.subscribe(function (astronaut) {
            _this.history.push(astronaut + " " + astronaut.length + " confirmed the mission");
        });
    }
    ...
    MissionControlComponent = __decorate([
        ...
        __metadata('design:paramtypes', [(typeof (_a = typeof mission_service_1.MissionService !== 'undefined' && mission_service_1.MissionService) === 'function' && _a) || Object])
